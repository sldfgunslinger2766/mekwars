...
public class LongOperation implements Comparable {
	...
	private Vector  shortIDs;//running short ops
	...
	private Vector activeShorts;
	
	/*
	 * finally, the underpinning operation type 
	 * use name instead of reference. lookup latest
	 * version of the op when resolving, in case of
	 * param changes.
	 */
	 ...
	 * NOTE: this is by definition a long ID ...
	 */
	public int getID() {
		return longID;
	}
	 ...
	 * Used to pull matching Operation, which contains
	 * paramaters, from Manager and to match with shorts.
	 */
	...
	/**
	 * Method which returns a set of IDs
	 * for in-progress short ops under this
	 * particular longop instance.
	 */
	public Vector getActiveShortops() {
	...
	/**
	 * Method to add a new ShortOperation to the
	 * activeShortOps vector. After addition, the
	 * vector is re-sorted by ID.
	 */
	...
	public int compareTo(Object o) {
		...
		if (o instanceof LongOperation) {
			LongOperation compOp = (LongOperation)o;
