 ...
 *
 *	Loads the default settings for the server config
 *  If any configs are added please add them to this function
 *  as well as createConfig().
 */
public class DefaultServerOptions {
    ...
    protected void createDefaults() {
        ...
        defaults.setProperty("ShowVehWeightclassInChallenges", "false");//TODO: Make this a client option.
        ...
        defaults.setProperty("ScrapsAllowed", "1");//nee "ScrappingAllowed", 6.12.05 @urgru
        defaults.setProperty("ScrapCostMultiplier", ".40");//nee "ScrappingCostsBills", 11.12.06 @urgru
        defaults.setProperty("DonationsAllowed", "2");//nee "DonatingAllowed", 6.12.05 @urgru 
        defaults.setProperty("DonationCostMultiplier", ".20");//nee "DonatingCostsBills", 11.12.06 @urgru
        defaults.setProperty("UsedPurchaseCostMulti", ".50");//@urgru 11.12.06 
        ...
        defaults.setProperty("FlatMaxUnitLossPayment", "0");//int. 0 ensures no payment by default.
        ...
        defaults.setProperty("InfantryMayBeSoldOnBM", "false");//10.23.05 @urgru
        ...
        defaults.setProperty("WelfareCeiling", "30");//go above this and you no longer can pull welfare units
        defaults.setProperty("WelfareTotalUnitBVCeiling", "3000");//Go above this and you no longer can pull welfare units
        ...
        defaults.setProperty("UseBlindDrops","false");//TODO: move this into ops
        ...
        defaults.setProperty("MekToInfantryRatio","100");// with AllowRatios on this well set your inf to mek Ratio 100% 50% if 50% then 1 inf for every 2 meks
        ...
        defaults.setProperty("DefaultUpperLimit", "4");//make this client configurable eventually
        defaults.setProperty("DefaultLowerLimit", "4");//make this client configurable eventually
        ...
        defaults.setProperty("MaxAllowedPilotsInQueueToBuyFromHouse","2"); //if the player has more then 2 pilots in their queue of a size and wieght they cannot buy from the faction.
        ...
        defaults.setProperty("DisconnectionTimeToReport","600");//10 minutes to report
        defaults.setProperty("DisconnectionGracePeriod", "120");//2 minute grace period after crash
        ...
        defaults.setProperty("CostModifier","1.0"); //this is set to off lower or raise the calculated cost. i.e. cost is 10 mil for a unit .1(10%) will set it to 1 mil.
        ...
        /*
         * Number of seconds it will take to repair a crit/weapon
         * Based on Maxtech repairs i.e. engines take longer to repair then
         * Medium Lasers or Actuators.
         */
        defaults.setProperty("TimeForEachRepairPoint","60");

        /* 
         * What it costs to repair each crit.
         * Note this will be accumulative as all the crits will be counted
         * i.e. Large Laser with 2 cirts will cost more to repair then 
         * a medium Laser.
         * Engines are based on the total number of crits for the engine 
         * not just the number of crits damaged. i.e. a STD engine costs less to
         * repair then an XL engine.
         */ 
        ...
        /*
         * This is used to modify the cost of real repairs. i.e. scale
         * them up or down depending on the SO's choice value of .75
         * would use 75% of the real cost.
         */
        ...
        defaults.setProperty("AuctionFee","0.15");//double, so .15 = 15% of the price is taken as fee
        defaults.setProperty("RareMinSaleTime","30");//in ticks
        defaults.setProperty("ChanceToSendUnitToBM","40");//int % chance to sell instead of autoscrapping
        
        /*
         * BM blocking.
         * 
         * Lists are $ delimited and case sensitive, such that a value of
         * "Liao$Marik$Davion" for BMNoSell would stop all sales attempts
         * by players in factions w/ those exact names.
         * 
         * "NoClanTech" is a boolean. If true, no *player* will be able to
         * sell clan units on the BM, but house overflows (unless NoSell is
         * enabled for the house) and rare production can still go on. 
         */
        ...
        /*
         * Price adjustments for purchases from factories not originally owned by the
         * faction. This adjustment stacks with any faction penalty already attached to
         * the factory. Float values, used as multipliers. Examples:
         * 
 ...
 */
    public void createConfig() {
    	try {
    		...
    		MMServ.mmlog.errLog("Unable to save config file.");
    		MMServ.mmlog.errLog(ex);
    		MMServ.mmlog.errLog(ex.getMessage());
    	}
    }
