...
public class MWServ {
	...
	public static final String SERVER_VERSION = "0.2.33.0";//Sync this with the clientVersion in MMClient @Torren 
				...
				if (!name.equals(logname)) {
					...
					if ((a != null) && (b != null)) {
						if ( a.getGroupAllowance() != 0 && a.getGroupAllowance() != b.getGroupAllowance() ) {
							//CampaignData.mwlog.modLog("Double Accounting: " + nametmp + " and " + logname + " IP: " + hisip);
