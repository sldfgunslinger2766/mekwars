...
class ClientThread extends Thread implements GameListener, CloseClientListener  {
	...
	public void run() {
        ...
        MWClient.mwClientLog.clientErrLog("Debug 1");
		try {
			sleep(500);
			client.connect();
			sleep(500);
        ...
        MWClient.mwClientLog.clientErrLog("Debug 2");
		//client.retrieveServerInfo();
		try {
			while (client.getLocalPlayer() == null) {
				sleep(50);
			}
	        MWClient.mwClientLog.clientErrLog("Debug 3");
	        ...
	        MWClient.mwClientLog.clientErrLog("Debug 4");
            ...
            MWClient.mwClientLog.clientErrLog("Debug 5");
            ...
            MWClient.mwClientLog.clientErrLog("Debug 6");
			...
			if ((client.game != null && client.game.getPhase() == IGame.PHASE_LOUNGE)) {
		        ...
		        MWClient.mwClientLog.clientErrLog("Debug 7: mechs:"+this.mechs.size()+" options: "+xmlGameOptions.size());
		        ...
		        MWClient.mwClientLog.clientErrLog("Debug 8");
                ...
                MWClient.mwClientLog.clientErrLog("Debug 9");
                ...
                MWClient.mwClientLog.clientErrLog("Debug 10");
		        ...
		        MWClient.mwClientLog.clientErrLog("Debug 11");
                ...
                MWClient.mwClientLog.clientErrLog("Debug 12");
                ...
                MWClient.mwClientLog.clientErrLog("Debug 15");

			}
	        MWClient.mwClientLog.clientErrLog("Debug 16");
