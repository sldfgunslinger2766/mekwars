	...
	public synchronized void run (){
        while(true){
            try{
                ...
                MWClient.mwClientLog.clientErrLog("Error in Salvage Management Queue");
        ...
        synchronized(workOrders){
            for ( int pos = UnitUtils.TECH_GREEN; pos <= UnitUtils.TECH_PILOT; pos++){
                ...
                while (workQueue.hasNext()){
                    ...
                    if ( unit == null ){
                        MWClient.mwClientLog.clientErrLog("Unable to find unit to salvage. removing salvage job");
