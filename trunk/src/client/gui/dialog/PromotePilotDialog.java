...
public class PromotePilotDialog extends JFrame implements ActionListener, KeyListener{
    ...
    private void loadPanel() {
        ...
        MasterPanel.add(new JLabel("Current Exp",JLabel.TRAILING));
        ...
        MasterPanel.add(new JLabel("Exp Cost",JLabel.TRAILING));
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforATfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforDMfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforMSfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforPRfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforSVfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforIMfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforEDfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
                && (!pilot.getSkills().has(PilotSkill.EdgeSkillID)
                        || pilot.getSkills().getPilotSkill(PilotSkill.EdgeSkillID).getLevel() < Integer.parseInt(mwclient.getserverConfigs("MaxEdgeChanges")))) {
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforMAfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforNAPfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforNAGfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
                && !pilot.getSkills().has(PilotSkill.NaturalAptitudePilotingSkillID)) {
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforWSfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforTGfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforGMfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforGBfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforGLfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforTNfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforEIfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforGTfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforQSfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforMTfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforVDNIfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforBVDNIfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("chanceforPSfor"+Unit.getTypeClassDesc(playerUnit.getType()))) > 0
