...
public final class ConfigurationDialog implements ActionListener {
    ...
    private final String[] playerChatColorChoices = { "Player Defined",
            "Faction Colors", "Mixed (Faction Tag)", "Mixed (Faction Name)" };
    ...
    public ConfigurationDialog(MWClient c) {
        ...
        if (upperCBoxesCounter != 0) {
        	...
        	useStatusForIconBox.setToolTipText("<HTML>"
					...
					+ "moving between multiple servers or programs.<br>" + "<br>"
        ...
        /*
         * NOTE:
         * If we were to include GAMEPASSWORD support on the config dialog,
         * this would the the appropriate place to do it. As of July 2006, no
         * server allows players to password protect theis hosts, so inclusion
         * in the GUI would be counter productive. @urgru 7/11/06
         */
        ...
        JLabel dedicatedServiceHeader = new JLabel("<HTML><body><CENTER><b>"
        ...
        dedicatedServiceHeader.setBorder(BorderFactory.createCompoundBorder(
         ...
         * HUD Panel
         * 
         * Check boxes are used to display everything.
         */
         ...
         * for the to-main options.
         * 
         * Dummy check boxes are created in the Top column for the chat tabs
         * which are only avaliable in the lower pane. A NEW dummy must be
         * created for each, as the formatter blows up if the same dummy is used
         * multiple times.
         * 
        ...
        /*
         * Format the TABNAMING panel. Example of the layout:
         * 
         * Name Displayed: Shortcut: Headquarters: Headquarters H
         */
        ...
        /*
         * Construct a function key binding panel.
         * 
         * Least complex panel. Woo =)
         */
        ...
        JLabel keyBindHeader1 = new JLabel(
                "Function keys can be configured to run");
        JLabel keyBindHeader2 = new JLabel(
                "commands. /c is prepended to the strings.");
        ...
        /*
         * ADD THE NEWLY FORMATTED PANELS AS TABS
         * 
         * Because I'm a dolt, some of the tabs formatted above are embedded
         * within JPanels with flow layouts. This makes them center, instead of
         * aligning left.
         */
        ...
        String chatNameColorMode = mwclient.getConfigParam(
                "PLAYERCHATCOLORMODE").toLowerCase();
