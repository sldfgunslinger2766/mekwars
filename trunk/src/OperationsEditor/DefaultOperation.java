...
public class DefaultOperation {
	...
	public DefaultOperation() {
         ...
         * DefenderMulArmyList			[List of the MUL files to choose from seperated by ;
         ...
         * AttackerMulArmyList			[List of the MUL files to choose from seperated by ;
         * 								[These files exist in the servers data\armies folder
         * 
	...
	//METHODS
	/**
	 * Method which returns the default value of
	 * a given operation paramater. @urgru 5/30/05
	 */
