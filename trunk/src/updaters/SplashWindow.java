...
class AnimationThread extends Thread {
    ...
    private void updateProgress(){
        switch (progress) {
        case 0:	splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>е</b></CENTER></HTML>"); break;
		case 1:	splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>ее</b></CENTER></HTML>"); break;
		case 2:	splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>еее</b></CENTER></HTML>"); break;
		case 3: splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>ееее</b></CENTER></HTML>"); break;
		case 4: splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>еееее</b></CENTER></HTML>"); break;
		case 5: splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>ееееее</b></CENTER></HTML>"); break;
		case 6: splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>еееееее</b></CENTER></HTML>"); break;
		case 7: splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>ееееееее</b></CENTER></HTML>"); break;
		case 8: splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>еееееееее</b></CENTER></HTML>"); break;
		case 9: splash.getImageLabel().setText("<HTML><CENTER><b>" + progressText + "<br>ееееееееее</b></CENTER></HTML>"); break;
        }
    }
	@Override
