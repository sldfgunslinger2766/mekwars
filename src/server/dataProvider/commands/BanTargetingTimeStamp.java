    ...
    public void execute(Date timestamp, BinWriter out, CampaignData data) throws Exception {
        ...
        if (bannedAmmo.exists()) {
            ...
            try {
                ...
                MMServ.mmlog.infoLog("Error reading first line from bantargeting.dat");       
            }
        } 
        
        else
            MMServ.mmlog.infoLog("bantargeting.dat didn't exist. returning ficticious timestamp to requesting client.");       
