...
public class AdminCreateSolarisCommand implements Command {
	...
	public void process(StringTokenizer command,String Username) {
		...
		SHouse solaris = new NewbieHouse(CampaignMain.cm.getData().getUnusedHouseID(),
				CampaignMain.cm.getConfig("NewbieHouseName"),
				"#33CCCC", 4, 5, "SOL");
		
		CampaignMain.cm.addHouse(solaris);
		HashMap<SHouse,Integer> solFlu = new HashMap<SHouse,Integer>();
		solFlu.put(CampaignMain.cm.getHouseFromPartialString(CampaignMain.cm.getConfig("NewbieHouseName"),null),new Integer(100));
		SPlanet newbieP = new SPlanet(0,"Solaris VII", 
