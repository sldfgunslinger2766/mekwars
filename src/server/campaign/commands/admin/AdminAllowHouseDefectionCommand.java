	...
	public void process(StringTokenizer command,String Username) {
		...
		try{
			...
			if ( !lock ) {
				...
				//server.MMServ.mmlog.modLog(Username + " has blocked defection "+toFrom.toLowerCase()+" "+ faction.getName());
				...
				//server.MMServ.mmlog.modLog(Username + " has allowed defection "+toFrom.toLowerCase()+" "+ faction.getName());
