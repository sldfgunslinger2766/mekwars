...
public class RequestDonatedCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (p.getMyHouse().isNewbieHouse()) {
            ...
            result += "AM:<br><a href=\"MEKWARS/c request#resetunits\">Click here to request a reset of your units.</a>";
        ...
        if (spaceTaken > p.getFreeBays()) {// if only needs more technicians
            ...
            if (totalCost > p.getMoney()) {
                if (useBays) {
                    result = "AM:Command will not assign the requested unit to your force unless support is in place; however, you cannot afford to " + "buy the unit *and* purchase bays. Total cost would be " + CampaignMain.cm.moneyOrFluMessage(true, false, totalCost) + " and you only have " + p.getMoney() + ".";
                } else {
                    result = "AM:Command will not assign the requested unit to your force unless support is in place; however, you cannot afford to " + "buy the unit *and* hire technicians. Total cost would be " + CampaignMain.cm.moneyOrFluMessage(true, false, totalCost) + " and you only have " + p.getMoney() + ".";
                }
            ...
            if (useBays) {
                ...
                result += "<br><a href=\"MEKWARS/c hireandrequestused#" + numTechs + "#" + Unit.getWeightClassDesc(weightclass) + "#" + type_id + "\">Click here to purchase the bays and purchase the unit.</a>";
            } else {
                ...
                result += "<br><a href=\"MEKWARS/c hireandrequestused#" + numTechs + "#" + Unit.getWeightClassDesc(weightclass) + "#" + type_id + "\">Click here to hire the technicians and purchase the unit.</a>";
            }
