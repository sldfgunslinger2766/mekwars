 ...
 * 
 * Also note, that the skill should not hold any internal state depending on 
 * any parameter passed to any function to it, since the instance created only
 * once and then shared among all pilots.
 * 
...
public abstract class SPilotSkill extends PilotSkill {
     ...
     * to the pilot's skill list. As example it could remove other skills on
     * its list (look at SLevelPilotSkill), or auto-add another skill (you 
     * have to call modifyPilot for that auto-added by yourself!).
     */
