 ...
 public class MWCyclopsComm extends Thread{
	...
	public synchronized void run (){
     ...
     public void checkup(){
         ...
         if ( version.substring(start,end).equals("1") )
             version = "Cyclops is UP";
         else
             version = "Cyclops is DOWN";
     ...
     public void reset(){
         ...
         if ( version.substring(start,end).equals("1") )
             version = "Cyclops DataBase Reset Complete";
         else
             version = "Cyclops DataBase Reset failed";
     ...
     public void optimize(){
         ...
         if ( version.substring(start,end).equals("1") )
             version = "Cyclops DataBase Optimize Complete";
         else
             version = "Cyclops DataBase Optimize failed";
     ...
     public void pilotWrite(SPilot pilot, String player){
         ...
         //no need to write vacant pilots.
     ...
     public String sendMessage(String message,boolean log){
         ...
         //CampaignData.mwlog.infoLog("Sending Message to Cyclops: "+message);
         StringBuilder ret;
         try{
             ...
             //if debug is on then record the log.
             if ( log ){
